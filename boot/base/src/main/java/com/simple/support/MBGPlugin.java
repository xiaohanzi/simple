 ...
 * @date 2018-01-02.
 */
public class MBGPlugin extends FalseMethodPlugin {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        while(var5.hasNext()) {
            ...
            interfaze.addSuperInterface(new FullyQualifiedJavaType(mapper + "<" + entityType.getShortName() + "," + Long.class.getSimpleName() + ">"));
        }
